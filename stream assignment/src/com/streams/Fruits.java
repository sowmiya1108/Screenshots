...
class Streamprogramfruits{
    public static void main(String[] args){
        ArrayList<Fruits>fruitList=new ArrayList<Fruits>();
        fruitList.add(new Fruits(100,"apple",40,"red"));
        fruitList.add(new Fruits(100,"orange",40,"orange"));
        fruitList.add(new Fruits(100,"mango",40,"yellow"));
        fruitList.add(new Fruits(100,"grapes",40,"green"));
